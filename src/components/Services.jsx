        ...
        <div className="relative">
                ...
                {brainwaveServices.map((item, index) => (
                  <li
                    ...
                    className={`flex items-start py-4 border-t border-n-6 ${
                      index == brainwaveServices.length - 1 ? "border-b" : ""
                    }`}
                  >
                    <img
                      src={check}
          ...
          <div className="relative grid gap-5 z-1 lg:grid-cols-2">
            ...
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-/90 lg:p-15 ">
                      ...
                      className={`rounded-2xl flex items-center justify-center ${
                        index === selected
                          ? // ? "w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]"
                            "flex w-10 h-10 bg-conic-gradient p-0.5 md:w-15 md:h-15 transition-all"
